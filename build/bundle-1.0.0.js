...
function create_if_block ( state, component ) {
	...
	return {
		...
		update: function ( changed, state ) {
			...
			if ( Object.keys( pythagoras_changes ).length ) { pythagoras.set( pythagoras_changes ); }
			...
			if ( Object.keys( pythagoras_1_changes ).length ) { pythagoras_1.set( pythagoras_1_changes ); }
		},
...
Pythagoras.prototype.teardown = Pythagoras.prototype.destroy = function destroy ( detach ) {
	this.fire( 'destroy' );
